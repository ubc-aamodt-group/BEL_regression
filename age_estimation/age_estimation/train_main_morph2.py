...
TRAIN_CSV_PATH = '../dataset/morph2morph2_train.csv'
VALID_CSV_PATH = '../dataset/morph2/morph2_valid.csv'
TEST_CSV_PATH = '../dataset/morph2/morph2_test.csv'
IMAGE_PATH = '../dataset/morph2/morph2-aligned'
