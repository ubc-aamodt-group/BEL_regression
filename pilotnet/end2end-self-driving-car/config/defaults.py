...
_C.MODEL.WEIGHTS = ""#"/home/fzyxue/regression_compression/end2end-self-driving-car/log/run_2021-01-07_16:05:03/weights_final.pth" #"./weights_final.pth"  # should be a path to pth or ckpt file
_C.MODEL.NBITS = 1
_C.MODEL.TRANSFORM = "mae"
...
_C.MODEL.FC.LAYERS = [             # Adhere to [out_channels, (kernel_h, kernel_w), stride]
    {'to_size': 1000, 'dropout': .5, 'norm': False},
    {'to_size': 500, 'dropout': .5, 'norm': False},
    {'to_size': 100, 'dropout': .0, 'norm': False},
...
_C.MODEL.BACKWARD_CNN.LAYERS = [     # Adhere to [out_channels, (kernel_h, kernel_w), stride]
    ...
    {'out_channels': 1, 'kernel': (3, 3), 'stride': 1, },
    {'out_channels': 1, 'kernel': (6, 5), 'stride': 2, },
...
_C.SOLVER.CHECKPOINT_PERIOD = 25000
...
_C.LOG.PATH = './log'
_C.LOG.PERIOD = 1000
_C.LOG.WEIGHTS_SAVE_PERIOD = 100000
_C.LOG.PLOT = CN()
