...
import models_new_direct as hopenet
import helper_bcd_direct as helper
import datasets
...
def parse_args():
    ...
    parser.add_argument('--model_file', dest='model_file', help='architecture_type: resnet or resnet_stage.', default='resnet', type=str)
...
if __name__ == '__main__':
    ...
    di=pickle.load(open("code_pkl/bel"+args.code+"_150_tensor.pkl","rb"))
    dis=pickle.load(open("code_pkl/bel"+args.code+"_100_tensor.pkl","rb"))
    ...
    if args.dataset == 'Pose_300W_LP':
        ...
        val_pose_dataset = datasets.Pose_300W_LP_random_ds(args.data_dir, args.val_filename_list, transformations)
    elif args.dataset == 'AFLW2000':
        pose_dataset = datasets.AFLW2000(args.data_dir, args.filename_list, transformations)
        val_pose_dataset = datasets.AFLW2000(args.data_dir, args.val_filename_list, transformations)
    elif args.dataset == 'BIWI':
        pose_dataset = datasets.BIWI_bcd(args.data_dir, args.filename_list, transformations,num_bits=args.num_bits,code_bits=args.code_bits, code=args.code)
        test_pose_dataset = datasets.BIWI_bcd(args.data_dir, args.test_filename_list, transformations,num_bits=args.num_bits,code_bits=args.code_bits, code=args.code)
    ...
    helper.test(model, test_loader, pose_dataset, args.output_string, gpu, args.arch,args.lr,50,batch_size,195,args.num_bits,args.code_bits,args.code,loss_func,di,dis)
